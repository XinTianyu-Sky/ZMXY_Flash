package com.hurlant.crypto.hash
{
   public class SHA256 extends SHABase implements IHash
   {
      ...
      override protected function core(param1:Array, param2:uint) : Array
      {
         ...
         var _loc3_:Array = [];
         var _loc4_:uint = _loc11_[0];
         var _loc5_:uint = _loc11_[1];
         var _loc6_:uint = _loc11_[2];
         var _loc7_:uint = _loc11_[3];
         var _loc8_:uint = _loc11_[4];
         var _loc9_:uint = _loc11_[5];
         var _loc10_:uint = _loc11_[6];
         _loc11_ = _loc11_[7];
         var _loc12_:uint = 0;
